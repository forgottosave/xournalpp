...
void ToolMenuHandler::initToolItems() {
    ...
    addCustomItemTgl("SELECT_REGION", ACTION_TOOL_SELECT_MULTILAYER_REGION, GROUP_TOOL, true, "select-lasso", _("Select Multi-Layer Region"));
    addCustomItemTgl("SELECT_RECTANGLE", ACTION_TOOL_SELECT_RECT, GROUP_TOOL, true, "select-rect", _("Select Rectangle"));
    addCustomItemTgl("SELECT_REGION", ACTION_TOOL_SELECT_MULTILAYER_RECT, GROUP_TOOL, true, "select-lasso", _("Select Multi-Layer Rect"));
