...
auto ToolHandler::isSinglePageTool() const -> bool {
    ...
    return ((toolType == TOOL_PEN || toolType == TOOL_HIGHLIGHTER) &&
           ...
           toolType == TOOL_SELECT_REGION || toolType == TOOL_SELECT_MULTILAYER_REGION || toolType == TOOL_SELECT_RECT ||
           toolType == TOOL_SELECT_MULTILAYER_RECT || toolType == TOOL_SELECT_OBJECT ||
