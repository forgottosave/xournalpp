...
void ToolHandler::initTools() {
    ...
    tools[TOOL_SELECT_MULTILAYER_RECT - TOOL_PEN] =
            std::make_unique<Tool>("selectMultiLayerRect", TOOL_SELECT_MULTILAYER_RECT, Color{0x000000U}, TOOL_CAP_NONE, std::nullopt);

    tools[TOOL_SELECT_MULTILAYER_REGION - TOOL_PEN] =
            std::make_unique<Tool>("selectMultiLayerRegion", TOOL_SELECT_MULTILAYER_REGION, Color{0x000000U}, TOOL_CAP_NONE, std::nullopt);
...
void ToolHandler::setSelectionEditTools(bool setColor, bool setSize, bool setFill, bool setLineStyle) {
    ...
    if (this->activeTool->type == TOOL_SELECT_RECT || this->activeTool->type == TOOL_SELECT_MULTILAYER_RECT ||
        this->activeTool->type == TOOL_SELECT_REGION || this->activeTool->type == TOOL_SELECT_MULTILAYER_REGION ||
...
auto ToolHandler::isSinglePageTool() const -> bool {
    ...
    return ((toolType == TOOL_PEN || toolType == TOOL_HIGHLIGHTER) &&
           ...
           toolType == TOOL_SELECT_REGION || toolType == TOOL_SELECT_MULTILAYER_REGION ||
           toolType == TOOL_SELECT_RECT || toolType == TOOL_SELECT_MULTILAYER_RECT || toolType == TOOL_SELECT_OBJECT ||
