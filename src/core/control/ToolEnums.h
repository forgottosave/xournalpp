...
enum ToolType {
    ...
    TOOL_IMAGE = 5,
    TOOL_SELECT_RECT = 6,
    TOOL_SELECT_MULTILAYER_RECT = 7,
    TOOL_SELECT_REGION = 8,
    TOOL_SELECT_OBJECT = 9,
    TOOL_PLAY_OBJECT = 10,
    TOOL_VERTICAL_SPACE = 11,
    TOOL_HAND = 12,
    TOOL_DRAW_RECT = 13,
    TOOL_DRAW_ELLIPSE = 14,
    TOOL_DRAW_ARROW = 15,
    TOOL_DRAW_DOUBLE_ARROW = 16,
    TOOL_DRAW_COORDINATE_SYSTEM = 17,
    TOOL_FLOATING_TOOLBOX = 18,
    TOOL_DRAW_SPLINE = 19,
    TOOL_SELECT_PDF_TEXT_LINEAR = 20,
    TOOL_SELECT_PDF_TEXT_RECT = 21,
